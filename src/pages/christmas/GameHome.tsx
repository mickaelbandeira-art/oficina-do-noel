...
const GameHome = () => {
  ...
  return (
    <ChristmasLayout>
      {/* Flying Sleigh */}
      <div className="fixed top-12 sm:top-16 md:top-24 left-0 w-full pointer-events-none z-0 overflow-hidden">
        <img 
          src={sleighImage} 
          alt="Trenó do Papai Noel" 
          className="h-20 sm:h-28 md:h-44 lg:h-56 animate-fly-across"
        />
      </div>
      
      <div className="min-h-screen flex flex-col items-center justify-center px-3 sm:px-4 py-6 sm:py-8">
        <div className="text-center space-y-4 sm:space-y-6 md:space-y-8 max-w-2xl mx-auto animate-scale-in">
          {/* Logo Principal */}
          ...
          {/* Story */}
          <div className="glass-card rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 space-y-3 sm:space-y-4 text-christmas-red">
            <Gift className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 mx-auto text-christmas-red animate-pulse-glow" />
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2">
            <Button
              ...
              className="bg-christmas-red hover:bg-christmas-red/90 text-white text-base sm:text-lg md:text-xl px-6 py-4 sm:px-8 sm:py-5 md:py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse-glow"
            >
            ...
            <Button
              ...
              className="border-christmas-gold text-christmas-gold hover:bg-christmas-gold hover:text-christmas-dark text-base sm:text-lg md:text-xl px-6 py-4 sm:px-8 sm:py-5 md:py-6 rounded-full transition-all duration-300"
            >
